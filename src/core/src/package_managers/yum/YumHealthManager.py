...
class YumHealthManager(HealthManager):
    """ Helps with attempting automatic environment health restoration for yum where feasible to improve operation success rates """
