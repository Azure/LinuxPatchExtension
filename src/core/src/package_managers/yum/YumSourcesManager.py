...
class YumSourcesManager(SourcesManager):
    """ Helps with sources list management for Yum """
    def init(self, env_layer, execution_config, composite_logger, telemetry_writer, status_handler):
        super(SourcesManager, self).__init__(env_layer, execution_config, composite_logger, telemetry_writer, status_handler, package_manager_name=Constants.YUM)
        pass
