...
"""RPMManagerBase for Redhat and CentOS"""
import json
import re
...
class RPMManagerBase(PackageManager):
    """Implementation of shared Redhat/CentOS/Mariner package management operations"""

    def __init__(self, env_layer, execution_config, composite_logger, telemetry_writer, status_handler):
        super(RPMManagerBase, self).__init__(env_layer, execution_config, composite_logger, telemetry_writer, status_handler)
        # Repo refresh
