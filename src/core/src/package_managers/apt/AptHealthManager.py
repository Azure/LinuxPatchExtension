...
class AptHealthManager(HealthManager):
    """ Helps with attempting automatic environment health restoration for apt/dpkg where feasible to improve operation success rates """
