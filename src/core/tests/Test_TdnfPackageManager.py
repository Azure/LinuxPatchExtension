...
class TestAzL3TdnfPackageManager(unittest.TestCase):
    ...
    def test_update_image_default_patch_mode_raises_exception(self):
        ...
        backup_write_with_retry = self.runtime.env_layer.file_system.write_with_retry
        ...
        self.runtime.env_layer.file_system.write_with_retry = backup_write_with_retry
