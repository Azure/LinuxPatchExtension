...
class TestBootstrapper(unittest.TestCase):
    ...
    def test_check_sudo_status_all_attempts_failed(self):
        ...
        result = self.runtime.bootstrapper.check_sudo_status(raise_if_not_sudo=False)
    ...
    def test_check_sudo_status_throw_exception(self):
        ...
        with self.assertRaises(Exception) as context:
            self.runtime.bootstrapper.check_sudo_status(raise_if_not_sudo=True)
    ...
    def test_check_sudo_status_insufficient_output_lines(self):
        ...
        with self.assertRaises(Exception) as context:
            self.runtime.bootstrapper.check_sudo_status()
    ...
    def test_check_sudo_status_succeeds_on_third_attempt(self):
        ...
        result = self.runtime.bootstrapper.check_sudo_status(raise_if_not_sudo=True)
