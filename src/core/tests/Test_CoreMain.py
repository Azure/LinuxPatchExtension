...
class TestCoreMain(unittest.TestCase):
    ...
    def test_assessment_operation_truncation_over_size_limit(self):
        ...
        Constants.StatusTruncationConfig.NO_TRUNCATION_IN_X_SEC = 0
    ...
    def test_installation_truncation_with_only_install_packages_over_size_limit(self):
        ...
        self.assertTrue(len(message_patches) < len(json.loads(assessment_substatus["formattedMessage"]["message"])["patches"]))   # truncated message < before truncated message
