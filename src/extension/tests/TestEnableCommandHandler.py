...
class TestEnableCommandHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ext_output_status_handler = ExtOutputStatusHandler(self.logger, self.utility, self.json_file_handler, "test.log", 1234, os.path.join(os.path.pardir, "tests", "helpers"))
