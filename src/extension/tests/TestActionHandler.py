...
class TestActionHandler(unittest.TestCase):
    def setUp(self):
        ...
        self.action_handler = ActionHandler(self.runtime.logger, self.runtime.telemetry_writer, self.runtime.utility, runtime_context_handler, self.runtime.json_file_handler, self.runtime.env_manager,
