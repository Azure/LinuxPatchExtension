...
class ActionHandler(object):
    ...
    def __init__(self, logger, telemetry_writer, utility, runtime_context_handler, json_file_handler, env_manager, ext_env_handler, ext_config_settings_handler, core_state_handler, ext_state_handler, ext_output_status_handler, process_handler, cmd_exec_start_time):
        self.logger = logger
